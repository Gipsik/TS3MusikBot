...
namespace TS3MusicForm
{
    public partial class Form1 : Form
    {
        ...
        {
            var getMusicBotID = QR.GetClientIdsByUniqueId("WLVpofVCGZ95V+XlLYa+3PPDQ7o="); // gets the client side music bot by the ID
        ...
        public void addToQueue(string user, string getCommand)
        {
            ...
            try
            {
                ...
                {
                    vidURL = vidURL.Remove(vidURL.IndexOf('?'), vidURL.Length - vidURL.IndexOf('?'));
                }
        ...
        private void encounteredErrorOrEnd(object sender, EventArgs e) { getNextSong(); } // song has ended or VLC as errored, get the next song
